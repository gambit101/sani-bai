...
const About = () => {
    ...
    return (
        <div className="">
            <h1 className='text-5xl font-bold text-blue-950 mt-20 text-center border-b-[1px] border-gray-500 pb-10 mx-20'>Get in Touch With us</h1>

            <div className="md:flex gap-40 mx-20">
                <div>
                ...
                <div>
                    ...
                    <input placeholder="Message" type="text" name="" id="" className="border-[3px] px-40 py-8 mt-3" />
            ...
            <footer className="footer p-10 bg-gray-500  text-white mt-20">
                <nav>
